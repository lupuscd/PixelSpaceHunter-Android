...
public class EnemyBosses : MonoBehaviour
{
    ...
    private void Fire()
    {
        ...
        pos.x = transform.position.x + 0.105f;
        poss.x = transform.position.x - 0.095f;
        GameObject bullet = Instantiate(bulletPrefab, transform.position, Quaternion.identity) as GameObject;
        GameObject bullet2 = Instantiate(bulletPrefab, pos, Quaternion.identity) as GameObject;
        GameObject bullet3 = Instantiate(bulletPrefab, poss, Quaternion.identity) as GameObject;
